...
import { JsonController, Get, Param, BadRequestError, UseAfter } from 'routing-controllers';
...
export class ReportsController extends BaseController {
	...
	@Get('/event/:id')
	async getEventReportsById(@Param('id') id: string) {
